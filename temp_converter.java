...
public class temp_converter extends Application {
    ...
    public static void aboutApp() {
        ...
        alertDialog.setContentText("First select the choice i.e Celsius to Fahrenheit or Fahrenheit to Celsius an then enter value then click on convert button. Avoid to insert invalid value in Input Field");
